        ...
        private void LoadBows()
        {
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.pierce_per_level, new Tuple<float, float, float, bool>(3, 0, 50, true) },
                    { ItemStat.spirit, new Tuple<float, float, float, bool>(24, 0, 200, true) },
                    { ItemStat.spirit_per_level, new Tuple<float, float, float, bool>(2, 0, 50, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(5, 0, 150, true) },
                    ...
                    { ItemStat.primary_attack_flat_health_cost, new Tuple<float, float, float, bool>(12, 0, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.spirit_per_level, new Tuple<float, float, float, bool>(2, 0, 50, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(3, 0, 150, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(20, 0, 300, true) },
                    { ItemStat.draw_stamina_drain, new Tuple<float, float, float, bool>(4, 1, 50, true) },
                    { ItemStat.primary_attack_flat_health_cost, new Tuple<float, float, float, bool>(8, 0, 50, true) },
                    { ItemStat.primary_attack_percent_health_cost, new Tuple<float, float, float, bool>(0, 0, 50, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 500, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                    { ItemStat.bow_draw_speed, new Tuple<float, float, float, bool>(2, 0.01f, 2, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.pierce_per_level, new Tuple<float, float, float, bool>(2, 0, 50, true) },
                    { ItemStat.lightning, new Tuple<float, float, float, bool>(4, 0, 90, true) },
                    { ItemStat.lightning_per_level, new Tuple<float, float, float, bool>(1, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(3, 0, 50, true) },
                    { ItemStat.draw_stamina_drain, new Tuple<float, float, float, bool>(6, 1, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.spirit_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(3, 0, 150, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(150, 0, 300, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(100, 0, 300, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.frost_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(3, 0, 150, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(200, 0, 300, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(100, 0, 300, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.poison_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.lightning, new Tuple<float, float, float, bool>(30, 0, 99, true) },
                    { ItemStat.lightning_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
        ...
        private void LoadSwords()
        {
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.slash_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(55, 0, 120, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(52, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.blunt_per_level, new Tuple<float, float, float, bool>(4, 0, 50, true) },
                    { ItemStat.slash, new Tuple<float, float, float, bool>(25, 0, 120, true) },
                    { ItemStat.slash_per_level, new Tuple<float, float, float, bool>(2, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(40, 0, 120, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(18, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.lightning_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(40, 0, 120, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(8, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.slash_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    { ItemStat.spirit, new Tuple<float, float, float, bool>(20, 0, 120, true) },
                    { ItemStat.spirit_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(40, 0, 120, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(12, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(8, 1, 30, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.pierce_per_level, new Tuple<float, float, float, bool>(4, 0, 50, true) },
                    { ItemStat.frost, new Tuple<float, float, float, bool>(25, 0, 120, true) },
                    { ItemStat.frost_per_level, new Tuple<float, float, float, bool>(1, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(40, 0, 120, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(30, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.frost_per_level, new Tuple<float, float, float, bool>(1, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(55, 0, 120, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(48, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(16, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.slash_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(55, 0, 160, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(28, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.spirit_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(55, 0, 160, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(40, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.poison_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(55, 0, 160, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(36, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.fire_per_level, new Tuple<float, float, float, bool>(1, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(55, 0, 160, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(49, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(18, 1, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.slash_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(40, 0, 120, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(4, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.slash_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(55, 0, 160, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(14, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.lightning_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(55, 0, 160, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(62, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
        ...
        private void LoadAxes()
        {
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(12, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.slash_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    { ItemStat.chop, new Tuple<float, float, float, bool>(30, 0, 200, true) },
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(2.5f, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(70, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(18, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(70, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(50, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(21, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 150, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(175, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(10, 1, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.spirit_per_level, new Tuple<float, float, float, bool>(0, 0, 50, true) },
                    { ItemStat.chop, new Tuple<float, float, float, bool>(45, 0, 200, true) },
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(80, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(26, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 150, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(175, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(12, 1, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(50, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(39, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 150, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(175, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(14, 1, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.poison_per_level, new Tuple<float, float, float, bool>(0, 0, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.poison_per_level, new Tuple<float, float, float, bool>(1, 0, 50, true) },
                    { ItemStat.chop, new Tuple<float, float, float, bool>(90, 0, 200, true) },
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(50, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(72, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 150, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(175, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(3, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(50, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(48, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 150, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(175, 0, 400, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.blunt_per_level, new Tuple<float, float, float, bool>(2, 0, 50, true) },
                    { ItemStat.slash, new Tuple<float, float, float, bool>(25, 0, 200, true) },
                    { ItemStat.slash_per_level, new Tuple<float, float, float, bool>(2, 0, 50, true) },
                    { ItemStat.lightning, new Tuple<float, float, float, bool>(10, 0, 200, true) },
                    { ItemStat.lightning_per_level, new Tuple<float, float, float, bool>(2, 0, 50, true) },
                    { ItemStat.chop, new Tuple<float, float, float, bool>(30, 0, 200, true) },
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(2.5f, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(70, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(18, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.fire_per_level, new Tuple<float, float, float, bool>(0, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(70, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(52, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(70, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(2.5f, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(70, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(78, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(70, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.poison_per_level, new Tuple<float, float, float, bool>(3, 0, 50, true) },
                    { ItemStat.chop, new Tuple<float, float, float, bool>(90, 0, 300, true) },
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(2.5f, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(70, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(78, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.chop_per_level, new Tuple<float, float, float, bool>(3, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(50, 0, 200, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(84, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(20, 0, 150, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(175, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(18, 1, 50, true) },
            ...
            new JotunnItem(
                ...
                {
                    { "FlametalNew", new Tuple<int, int>(12, 6) },
                    { "GemstoneRed", new Tuple<int, int>(4, 1) },
                    { "CharredBone", new Tuple<int, int>(10, 0) },
                    { "VAFlametal_Axe", new Tuple<int, int>(1, 0) },
                },
                new Dictionary<ItemSettings, int>
        ...
        private void LoadHammers()
        {
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.blunt_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    { ItemStat.poison, new Tuple<float, float, float, bool>(25, 0, 300, true) },
                    { ItemStat.poison_per_level, new Tuple<float, float, float, bool>(3, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(210, 0, 400, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(64, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.blunt_per_level, new Tuple<float, float, float, bool>(10, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(210, 0, 400, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(64, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(100, 0, 400, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.lightning_per_level, new Tuple<float, float, float, bool>(0, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(100, 0, 400, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(49, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.spirit_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(100, 0, 400, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(22, 0, 150, true) },
                    { ItemStat.block_force, new Tuple<float, float, float, bool>(50, 0, 120, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(12, 1, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.poison_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(100, 0, 400, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(31, 0, 150, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 400, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(14, 1, 50, true) },
                    { ItemStat.secondary_attack_stamina, new Tuple<float, float, float, bool>(24, 1, 50, true) },
        ...
        private void LoadAtgeirs()
        {
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.pierce_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(30, 0, 120, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(11, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.pierce_per_level, new Tuple<float, float, float, bool>(5, 0, 50, true) },
                    { ItemStat.lightning, new Tuple<float, float, float, bool>(10, 0, 50, true) },
                    { ItemStat.lightning_per_level, new Tuple<float, float, float, bool>(1, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(30, 0, 120, true) },
                    { ItemStat.block_armor, new Tuple<float, float, float, bool>(14, 0, 150, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(175, 0, 400, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.fire_per_level, new Tuple<float, float, float, bool>(3, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(30, 0, 120, true) },
        ...
        private void LoadShields()
        {
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.block_armor_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
        ...
        private void LoadDaggers()
        {
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.slash_per_level, new Tuple<float, float, float, bool>(1, 0, 50, true) },
                    { ItemStat.pierce, new Tuple<float, float, float, bool>(39, 0, 99, true) },
                    { ItemStat.pierce_per_level, new Tuple<float, float, float, bool>(1, 0, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.pierce_per_level, new Tuple<float, float, float, bool>(1, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(10, 0, 40, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(4, 1, 50, true) },
                    { ItemStat.secondary_attack_stamina, new Tuple<float, float, float, bool>(12, 1, 50, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 500, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.frost_per_level, new Tuple<float, float, float, bool>(0, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(10, 0, 40, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(10, 1, 50, true) },
                    { ItemStat.secondary_attack_stamina, new Tuple<float, float, float, bool>(30, 1, 50, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 500, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.poison_per_level, new Tuple<float, float, float, bool>(2, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(10, 0, 30, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(9, 1, 50, true) },
                    { ItemStat.secondary_attack_stamina, new Tuple<float, float, float, bool>(28, 1, 50, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(200, 0, 500, true) },
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(50, 0, 150, true) },
                },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.lightning_per_level, new Tuple<float, float, float, bool>(3, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(10, 0, 30, true) },
                    { ItemStat.primary_attack_stamina, new Tuple<float, float, float, bool>(14, 1, 50, true) },
        ...
        private void LoadMagic()
        {
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.poison_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.spirit_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    { ItemStat.blunt, new Tuple<float, float, float, bool>(120, 0, 200, true) },
                    { ItemStat.blunt_per_level, new Tuple<float, float, float, bool>(0, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(20, 0, 150, true) },
                    { ItemStat.primary_attack_eitr, new Tuple<float, float, float, bool>(35, 0, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.durability_per_level, new Tuple<float, float, float, bool>(10, 0, 150, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.frost_per_level, new Tuple<float, float, float, bool>(2, 0, 50, true) },
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.fire_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    { ItemStat.blunt, new Tuple<float, float, float, bool>(50, 0, 200, true) },
                    { ItemStat.blunt_per_level, new Tuple<float, float, float, bool>(0, 0, 50, true) },
                    { ItemStat.attack_force, new Tuple<float, float, float, bool>(20, 0, 150, true) },
                    { ItemStat.durability, new Tuple<float, float, float, bool>(50, 0, 500, true) },
        ...
        private void LoadPickaxes()
        {
            ...
            new JotunnItem(
                ...
                new Dictionary<ItemStat, Tuple<float, float, float, bool>>() {
                    ...
                    { ItemStat.pickaxe_per_level, new Tuple<float, float, float, bool>(6, 0, 50, true) },
                    ...
                    { ItemStat.primary_attack_flat_health_cost, new Tuple<float, float, float, bool>(4, 0, 50, true) },
                    { ItemStat.primary_attack_percent_health_cost, new Tuple<float, float, float, bool>(0, 0, 50, true) },
                    { ItemStat.secondary_attack_stamina, new Tuple<float, float, float, bool>(4, 0, 50, true) },
                    { ItemStat.secondary_attack_flat_health_cost, new Tuple<float, float, float, bool>(6, 0, 50, true) },
